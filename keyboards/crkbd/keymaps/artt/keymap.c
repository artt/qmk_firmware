...
[_NUM] = LAYOUT_split_3x6_3(
    KC_GRV,   GUI_LBRK, GUI_RBRK, LBRK,     RBRK,     XXXXXXX,         KC_PSLS,  KC_KP_7,  KC_KP_8,  KC_KP_9,  KC_PAST,  _______,
    KC_DEL,   KC_LABK,  KC_RABK,  KC_LPRN,  KC_RPRN,  XXXXXXX,         KC_PMNS,  KC_KP_4,  KC_KP_5,  KC_KP_6,  KC_PPLS,  _______,
...
[_SYM] = LAYOUT_split_3x6_3(
    KC_TILD,  KC_F1  ,  KC_F2  ,  KC_F3  ,  KC_F4  ,  XXXXXXX,         KC_VOLU,  KC_F9,    KC_F10,   KC_F11,   KC_F12,   _______,
    KC_DEL,   KC_AT,    KC_ASTR,  KC_DLR,   KC_CIRC,  XXXXXXX,         KC_MUTE,  KC_AMPR,  KC_HASH,  KC_EXLM,  KC_PERC,  _______,
...
[_NAV] = LAYOUT_split_3x6_3(
    _______,  XXXXXXX,  KC_WH_L,  KC_MS_U,  KC_WH_R,  KC_WH_U,         XXXXXXX,  KC_HOME,  KC_UP,    KC_END,   KC_PGUP,  _______,
    _______,  XXXXXXX,  KC_MS_L,  KC_MS_D,  KC_MS_R,  KC_WH_D,         KC_ACL2,  KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_PGDN,  _______,
